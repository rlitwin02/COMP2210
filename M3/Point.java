...
public final class Point implements Comparable<Point> {
  ...
  /** Compare two points with respect to the 
   slope each makes with this point. */
   ...
   /**
    * Defines a total order for Points based on the slope 
      that two specified points
